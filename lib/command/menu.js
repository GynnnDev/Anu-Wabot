cmd.on('dashboard', ['dashboard'], ['info'], async (msg, {
    ...
    let locationMessage = {jpegThumbnail:logo[used_logo%3].buffer}
...
cmd.on('menu-cmd', ['menu'], ['info'], async (msg, {
  ...
  "listMessage": {
    ...
    buttons = [{
        buttonId: prefix[0]+'infopenggunaan',
        buttonText: {
