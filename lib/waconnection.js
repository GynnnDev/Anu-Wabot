...
module.exports = class WAConnection {
  ...
  async sendMessageFromContent(mess, obj, opt = {}) {
    let prepare = await this.generateWAMessageFromContent(typeof mess == 'object'?mess.key.remoteJid: typeof mess == 'object'? mess.key.remoteJid: mess, obj, opt)
    await this.relayMessage(prepare.key.remotemess, prepare.message, {
